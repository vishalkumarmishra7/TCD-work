...
String src = "C:\\Users\\adhis\\Desktop\\Earlier Run\\";

String path1 = src + "diff dt 0, sort by AIC, 400 stocks\\Unique Stocks.csv";  /* Only need to be read once */

String path2 = src + "diff dt 0, sort by AIC, 400 stocks\\Historical Ledger.csv";
String path3 = src + "diff dt 0, sort by AIC, 400 stocks\\balances.csv";
        
String path4 = src + "diff gt 0, risk and reward combine 400 stocks\\Historical Ledger.csv";
String path5 = src + "diff gt 0, risk and reward combine 400 stocks\\balances.csv";
      
String path6 = src + "diff gt 0, sort by AIC, save earnings, 400 stocks\\Historical Ledger.csv";
String path7 = src + "diff gt 0, sort by AIC, save earnings, 400 stocks\\balances.csv";

String path8 = src + "diff gt 0.01, sort by diff desc, 400 stocks\\Historical Ledger.csv";
String path9 = src + "diff gt 0.01, sort by diff desc, 400 stocks\\balances.csv";
...
void draw()
{
  ...
  String[] stocks2_4 = new String[342];
    ...
    saveFrame("C:\\Users\\adhis\\Desktop\\Earlier Run\\frames\\" + frame + ".jpg");
}
